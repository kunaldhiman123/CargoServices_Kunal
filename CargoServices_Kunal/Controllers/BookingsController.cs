...
namespace CargoServices_Kunal.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CustomerID,FromAddress,ToAddress,Date")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CustomerID,FromAddress,ToAddress,Date")] Booking booking)
        {
            if (ModelState.IsValid)
            {
