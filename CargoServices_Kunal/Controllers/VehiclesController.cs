...
namespace CargoServices_Kunal.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,VehicleNo,VehicleTypeID")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,VehicleNo,VehicleTypeID")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
